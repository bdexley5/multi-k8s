...
kubectl set image deployments/client-deployment server=bdexley5/multi-client:$SHA
kubectl set image deployments/worker-deployment server=bdexley5/multi-worker:$SHA
